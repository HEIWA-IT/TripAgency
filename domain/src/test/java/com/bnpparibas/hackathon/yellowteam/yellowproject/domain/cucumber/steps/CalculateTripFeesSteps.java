...
public class CalculateTripFeesSteps {
    ...
    public void the_customer_asked_for_the_trip_price() {
        ...
        } catch (com.bnpparibas.hackathon.yellowteam.yellowproject.domain.error.BusinessException be) {
    ...
    private com.bnpparibas.hackathon.yellowteam.yellowproject.domain.Trip trip() {
